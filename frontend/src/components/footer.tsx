...
export default function Footer() {
	return <footer className="footer items-center p-4 bg-base-200 text-base-content absolute bottom-0 w-full">
		...
		<div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
			<Link to="https://www.github.com/jeanoza" target="_blank" className="fill-current hover:fill-primary">
			...
			<Link to="https://www.linkedin.com/in/kyubong-choi-489198176/" target="_blank" className="fill-current hover:fill-primary">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" >
